  ...
  return (
    <section class="text-gray-600 body-font overflow-hidden">
      <div className="flex justify-center items-center mt-3">
        <h2 className="text-[35px] text=[#000] font-semibold">
          Product Details
        </h2>
      </div>

      <div class="container px-5 -mt-[60px] py-24 mx-auto mr-11">
        <div class="lg:w-4/5 mx-auto flex flex-row">
          <div className="w-[800px] -ml-[90px]">
            <img
              alt="ecommerce"
          ...
          <div class="lg:pl-10 lg:py-6 mt-6 lg:mt-0 -ml-[330px] w-[700px]">
