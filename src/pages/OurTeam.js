  ...
  return (
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        ...
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">A talented and dedicated group of software engineers delivering innovative solutions with expertise and collaboration.</p>
      </div>
